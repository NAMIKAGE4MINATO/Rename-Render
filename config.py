...
FORCE_SUB = os.environ.get("FORCE_SUB", "Ranawatmahi") 
...
ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '1692507291').split()]
